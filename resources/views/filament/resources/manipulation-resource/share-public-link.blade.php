        ...
        <div class="space-y-2">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button @click.prevent="copyToClipboard()"
                    class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm font-medium rounded-md transition-colors duration-200 focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-col items-center space-y-4">
                ...
                <button @click.prevent="downloadQRCode()"
                    class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium rounded-md transition-colors duration-200 focus:outline-hidden focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center space-x-2">
